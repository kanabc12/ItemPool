...
public class FileManager {
	public static String getUrlRootPath() {
		...
		java.net.URL url = test.getClass().getResource("FileManager.class");
		...
		if (!urlRoot.startsWith("file")) {
			urlRoot = urlRoot.substring(1, urlRoot.length());
		} else {
			urlRoot = urlRoot.substring("file:/".length(), urlRoot.length());
		}
	...
	public static void main(String[] args){
		FileManager.newFolder("D:/Servers/tomcat-7.0.29/webapps/etsdoc/1/doc");
	}
